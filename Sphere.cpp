...
// ctor
///////////////////////////////////////////////////////////////////////////////
Sphere::Sphere(Shader& litShdr, Shader& ltCUBEshdr, unsigned int difMap, unsigned int specMap, float radius, int sectorCount, int stackCount, bool smooth) : interleavedStride(32) {
